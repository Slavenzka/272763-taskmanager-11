...
// Get board tasks containera after board render
...
// Render task create form inside board tasks container
render(boardTasksContainer, createTaskFormTemplate());

// Render cards in ammount of CARDS_QTY
for (let i = 0; i < CARDS_QTY; i++) {
  render(boardTasksContainer, createTaskCardTemplate());
}

// Render more button right after board tasks container
